...
env_alloc(struct Env **newenv_store, envid_t parent_id)
{
	...
	e->env_tf.tf_eflags |= FL_IF;
       /* if(e == &envs[3])
        {
        	e->env_tf.tf_ds = GD_KD | 3;
	        e->env_tf.tf_es = GD_KD | 3;
	        e->env_tf.tf_ss = GD_KD | 3;
	        e->env_tf.tf_cs = GD_KT | 3;
		e->env_tf.tf_eflags &= FL_IF_CLEAR;
        }*/
...
/*	
        =======================================================================	
	|| jab bhi yahan aao
	|| yaad rakhna ki BSS nahin imlement HO GAYA hai ab..BUJHAYA!!!!
	=======================================================================	
	*/
}
