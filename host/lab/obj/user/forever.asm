...
obj/user/forever:     file format elf32-i386
...
umain(void)
{
  ...
  800041:	e8 ef 00 00 00       	call   800135 <cprintf>
		sys_yield();
  800046:	e8 c2 0e 00 00       	call   800f0d <sys_yield>
  80004b:	eb ed                	jmp    80003a <umain+0x6>
...
libmain(int argc, char **argv)
{
  ...
  80005f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	env = 0;
  800062:	c7 05 24 50 80 00 00 	movl   $0x0,0x805024
  800069:	00 00 00 
	
	env = &envs[ENVX(sys_getenvid())];
  80006c:	e8 d0 0e 00 00       	call   800f41 <sys_getenvid>
  800071:	25 ff 03 00 00       	and    $0x3ff,%eax
  800076:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800079:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80007e:	a3 24 50 80 00       	mov    %eax,0x805024
  ...
  80008e:	c7 04 24 0e 1c 80 00 	movl   $0x801c0e,(%esp)
  800095:	e8 9b 00 00 00       	call   800135 <cprintf>
	umain(argc, argv);
...
exit(void)
{
  ...
  8000bb:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000be:	e8 f8 13 00 00       	call   8014bb <close_all>
	sys_env_destroy(0);
  8000c3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000ca:	e8 a6 0e 00 00       	call   800f75 <sys_env_destroy>
}
  8000cf:	c9                   	leave  
  8000d0:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800128:	e8 e3 0a 00 00       	call   800c10 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  80017c:	e8 8f 0a 00 00       	call   800c10 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800281:	0f be 80 37 1c 80 00 	movsbl 0x801c37(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80043f:	c7 44 24 08 48 1c 80 	movl   $0x801c48,0x8(%esp)
  800446:	00 
  ...
  80045f:	c7 44 24 08 51 1c 80 	movl   $0x801c51,0x8(%esp)
  800466:	00 
  ...
  80049b:	c7 45 e0 54 1c 80 00 	movl   $0x801c54,-0x20(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801143:	e8 ed ef ff ff       	call   800135 <cprintf>
	*dev = 0;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801228:	e8 08 ef ff ff       	call   800135 <cprintf>
  ...
  801281:	e8 6b fe ff ff       	call   8010f1 <dev_lookup>
{
  ...
  8012aa:	e8 86 ee ff ff       	call   800135 <cprintf>
  ...
  80130a:	e8 e2 fd ff ff       	call   8010f1 <dev_lookup>
{
  ...
  801338:	e8 f8 ed ff ff       	call   800135 <cprintf>
...
_panic(const char *file, int line, const char *fmt,...)
  ...
  80187a:	e8 b6 e8 ff ff       	call   800135 <cprintf>
  ...
  80189d:	e8 93 e8 ff ff       	call   800135 <cprintf>
	vcprintf(fmt, ap);
  8018a2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8018a6:	8b 45 10             	mov    0x10(%ebp),%eax
  8018a9:	89 04 24             	mov    %eax,(%esp)
  8018ac:	e8 23 e8 ff ff       	call   8000d4 <vcprintf>
	cprintf("\n");
  8018b1:	c7 04 24 1e 1c 80 00 	movl   $0x801c1e,(%esp)
  8018b8:	e8 78 e8 ff ff       	call   800135 <cprintf>
